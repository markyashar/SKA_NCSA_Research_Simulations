...
ax.set_ylabel(r'E_{theta}(db)')
ax.set_title(r'$Cortes\ Beam\ Pattern:\ E_{theta}\  vs.\ theta\ (deg.)$',fontsize=9.0)
# ax.plot(theta_data,ampl_theta_db_data,'b.')
# ax.plot(phi_data*radians,ampl_phi_db_data,'b.')
# ax.plot(phi_data*radians,ampl_phi,'b.')
# ax.plot(l_list,ampl_theta_db1,'b.')
ax.plot(l_list,cx_ampl_theta,'b.')
# ax.plot(theta_data,ampl_theta,'b.')
# ax.plot(phi_data,real_data_co,'b.')
# ax.semilogx(theta,E_theta_mag,'ro') 
...
ax.set_xlabel('l')
ax.set_ylabel('m')
ax.set_zlabel('ampl_theta_db_data')
plt.grid(True)
plt.show()
...
# print result_phi[:,0], result_theta[:,0]
...
for label in ax.get_xticklabels() + ax.get_yticklabels():
    label.set_fontsize(8.5)
ax.set_xlabel(r'l')
ax.set_ylabel(r'E_{theta}')
ax.set_title(r'$Cortes\ Beam\ Pattern:\ E_{theta}\  vs.\ l\ (rad.)$',fontsize=9.0)

ax.plot(l,ampl_theta,'b.')
# ax.semilogx(theta,E_theta_mag,'ro') 
plt.grid(True)
plt.show()  # display plot
...
plt.title(title,fontsize=8.2)
save_file = str(filename) + '_ant_pats_real_log.pdf'
